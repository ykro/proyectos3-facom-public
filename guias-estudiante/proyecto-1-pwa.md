...
- Que las cafeterías sean variadas: distintas categorías, zonas y especialidades.
...
- Accesibilidad: contraste AA, áreas táctiles cómodas, texto legible en pantallas de teléfono.
...
**Interfaz (UI/UX):**
- A la etiqueta (badge) de categoría dale un color distinto según la categoría: "Para trabajar" #6D2E46, "Brunch" #C84B31, "De barrio" #E3B23C (con texto oscuro #2B2B2B para que se lea), "Tostador" #4F772D, "Al paso" #3A6B7E.
- El texto del badge es blanco, excepto "De barrio" que usa texto oscuro. Bordes redondeados y padding horizontal cómodo.
...
- El botón "Volver" siempre visible y con buena área táctil.
